...
void setGPIOMode(GPIO_TypeDef* GPIOx,u8 pin,GPIOMode_TypeDef GPIO_Mode_x)
{
	//参照GPIO_Init函数写的
...
u8 turnGPIOxNum(GPIO_TypeDef* GPIOx)
{
	u8 i;
	if(GPIOx==GPIOA)i=0;
	else if(GPIOx==GPIOB)i=1;
	else if(GPIOx==GPIOC)i=2;
	else if(GPIOx==GPIOD)i=3;
	else if(GPIOx==GPIOE)i=4;
	else if(GPIOx==GPIOF)i=5;
	else if(GPIOx==GPIOG)i=6;
	else if(GPIOx==GPIOH)i=7;
	else if(GPIOx==GPIOI)i=8;
	else if(GPIOx==GPIOJ)i=9;
	else if(GPIOx==GPIOK)i=10;
	return i;
}
